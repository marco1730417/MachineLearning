...
#TRAINING 
nids_sol = glm(y ~ x1+x5+x6+x10+x12+x13+x16+x17+x22+x23+x24+x25+x26+x27+x28+x29+x32+x33+x34+x37+x38+x39+x40+x41,family=binomial()) #calculo de la regresion lineal (funcion directa)
...
y_estim =exp(
  nids_sol$coefficients[1]+
    ...
    nids_sol$coefficients[5]*x10+
    nids_sol$coefficients[6]*x12+
    nids_sol$coefficients[7]*x13+
    nids_sol$coefficients[8]*x16+
    nids_sol$coefficients[9]*x17+
    nids_sol$coefficients[10]*x22+
    nids_sol$coefficients[11]*x23+
    nids_sol$coefficients[12]*x24+
    nids_sol$coefficients[13]*x25+
    nids_sol$coefficients[14]*x26+
    nids_sol$coefficients[15]*x27+
    nids_sol$coefficients[16]*x28+
    nids_sol$coefficients[17]*x29+
    nids_sol$coefficients[18]*x32+
    nids_sol$coefficients[19]*x33+
    nids_sol$coefficients[20]*x34+
    nids_sol$coefficients[21]*x37+
    nids_sol$coefficients[22]*x38+
    nids_sol$coefficients[23]*x39+
    nids_sol$coefficients[24]*x40+
    nids_sol$coefficients[25]*x41)/ 
  (1+exp(
    nids_sol$coefficients[1]+
      nids_sol$coefficients[2]*x1+
      nids_sol$coefficients[3]*x5+
...
y_estimt =exp(
  nids_sol$coefficients[1]+
    ...
    nids_sol$coefficients[5]*x10t+
    nids_sol$coefficients[6]*x12t+
    nids_sol$coefficients[7]*x13t+
    nids_sol$coefficients[8]*x16t+
    nids_sol$coefficients[9]*x17t+
    nids_sol$coefficients[10]*x22t+
    nids_sol$coefficients[11]*x23t+
    nids_sol$coefficients[12]*x24t+
    nids_sol$coefficients[13]*x25t+
    nids_sol$coefficients[14]*x26t+
    nids_sol$coefficients[15]*x27t+
    nids_sol$coefficients[16]*x28t+
    nids_sol$coefficients[17]*x29t+
    nids_sol$coefficients[18]*x32t+
    nids_sol$coefficients[19]*x33t+
    nids_sol$coefficients[20]*x34t+
    nids_sol$coefficients[21]*x37t+
    nids_sol$coefficients[22]*x38t+
    nids_sol$coefficients[23]*x39t+
    nids_sol$coefficients[24]*x40t+
    nids_sol$coefficients[25]*x41t)/ 
  (1+exp(
    nids_sol$coefficients[1]+
      nids_sol$coefficients[2]*x1t+
      nids_sol$coefficients[3]*x5t+
...
minit = min(y_estimt) #valor minimo de la ecuacion estimada
